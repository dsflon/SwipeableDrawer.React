...
const SwipeableDrawer = ({
  ...
  useEffect(() => {
    if (openState && scrollableElement?.current) {
      ...
      setContentClientHeight(scrollableElement.current.clientHeight === 0 ? window.outerHeight : scrollableElement.current.clientHeight);
      setContentScrollHeight(scrollableElement.current.scrollHeight === 0 ? window.outerHeight : scrollableElement.current.scrollHeight);
